			...
			<div className={styles.design_and_development_container}>
				<div className={styles.design_and_development_text}>
					...
					<p>
						...
						Save yourself precious time and keep yourself from unwanted headaches
						from trying to keep up with what your customers want.
					</p>
					<p>
						Our process is painless and produce the results you desire. It all
						starts with a conversation and ends with a custom made solution that
						fosters client and customer satisfaction. Fill in the required
						information below and then check your email for follow-up
